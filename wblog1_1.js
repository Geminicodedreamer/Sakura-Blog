	...
	class Silence {
		constructor() {
			this.defaluts = {
				...
				topInfo: {
					title: 'Hi,I\'m Yubo Wang',
					text: '本该喊痛的年纪，你却喊用力',
					github: "https://github.com/Geminicodedreamer",
					weibo: "",
					telegram: "",
					music: "",
					twitter: "",
					zhihu: "",
					mail: "1925959013@qq.com",
				}
			};
		...
		buildCustomElements() {
			...
			$("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/mathblog/articles/11177049.html">友链</a><i></i></li>	<li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>');
			//添加标签icon
			...
			let guanyu = '<ul class="sub-menu">' +
					'<li><a href="https://www.cnblogs.com/mathblog/articles/11157339.html "><i class="fa fa-meetup" aria-hidden="true"></i>有关我</a></li>' +
					'<li><a href="https://www.cnblogs.com/mathblog/articles/11346906.html "><i class="fa fa-area-chart" aria-hidden="true"></i> 统计</a></li>' +
					'<li><a href="https://www.cnblogs.com/mathblog/articles/11350777.html "><i class="fa fa-heartbeat" aria-hidden="true"></i> 监控</a></li>' +
					'<li><a href="https://www.cnblogs.com/mathblog/p/11541835.html "><i class="iconfont icon-taohua" aria-hidden="true"></i> 主题</a></li>' +
					'</ul>';
		...
		buildCopyright() {
            ...
            // Theme <a href="https://github.com/Zou-Wang/CNblogs-Theme-Sakura" target="_blank">高木さん v${this.version}</a></div>`;
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/mathblog" alt="高木さん">' +
					'<ruby><span class="sakuraso">高木さん</span><span class="no">の</span><span class="shironeko">Blog</span>' +
					'<rt class="chinese-font">高木さん</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
		...
		mainHeader() {
			...
			var header =
					...
					`       <h1 class="center-text glitch is-glitching Ubuntu-font" data-text="Hi,I\'m Yubo Wang">${config.title}</h1>` +
		...
		for(let i = article_list.length-1;i>=0;i--)
		{
			...
			{
				let readMore = $(readMores[j])[0].href;
				let postTitle = $(PostTitles[j])[0].innerHTML;
				...
				`     <div class="post-meta"> <span><i class="iconfont icon-attention"></i>${readNum} 热度</span> <span class="comments-number"><i class="iconfont icon-mark"></i>${comNum} 条评论</span> <span><i class="iconfont icon-cc-user"></i><a href="https://www.cnblogs.com/mathblog/p/11157339.html"></a>${author}</span></div>` +
		...
		postHeader() {
			...
			if (window.location.href.indexOf('articles') === -1) {
				var header =
						`<p class="entry-census"><span><a href="https://www.cnblogs.com/mathblog"><img src="https://blog-static.cnblogs.com/files/blogs/832479/4.jpg.gif"></a></span><span><a href="https://www.cnblogs.com/mathblog">高木さん</a></span><span class="bull">·</span>${post_date}<span class="bull">·</span>${post_view_count} 次阅读</p>`;
