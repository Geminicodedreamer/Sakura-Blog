	...
	class Silence {
		constructor() {
			this.defaluts = {
				...
				topInfo: {
					title: 'Hi,I\'m Yubo Wang , Welcome here to acknowledge me',
					text: '本该喊痛的年纪，你却喊用力',
		...
		buildCustomElements() {
			...
			$("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/mathblog">友链</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>');
			//添加标签icon
			...
			let guanyu = '<ul class="sub-menu">' +
					'<li><a href="https://www.cnblogs.com/mathblog"><i class="fa fa-meetup" aria-hidden="true"></i> 我</a></li>' +
					'<li><a href="https://www.cnblogs.com/mathblog"><i class="fa fa-area-chart" aria-hidden="true"></i> 统计</a></li>' +
					'<li><a href="https://www.cnblogs.com/mathblog"><i class="fa fa-heartbeat" aria-hidden="true"></i> 监控</a></li>' +
					'<li><a href="https://www.cnblogs.com/mathblog"><i class="iconfont icon-taohua" aria-hidden="true"></i> 主题</a></li>' +
					'</ul>';
		...
		setHomeSuiBiList() {
			...
			console.log(document.getElementsByClassName('forFlow'));
